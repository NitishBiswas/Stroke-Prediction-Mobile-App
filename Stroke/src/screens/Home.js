    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <Text style={styles.bodyText}>
          ...
          when the blood supply to part of the brain is cut off. Strokes are a
          medical emergency and urgent treatment is essential. The sooner a
          person receives treatment for a stroke, the less damage is likely to
          happen.
        </Text>

        <TouchableOpacity
          style={styles.btnView}
          onPress={() => navigation.navigate('Stroke Prediction')}>
        ...
        <View style={styles.cardView}>
          <Image
            resizeMode="contain"
            source={require('../images/stroke.png')}
            style={styles.cardImage}
          />
          <Text style={styles.bodyTitle}>
          ...
          <Text style={styles.bodyText}>
            Some people have strokes without realizing it. They're called silent
            strokes, and they either have no easy-to-recognize symptoms, or you
            don't remember them. But they can predict stroke from this machine.
          </Text>
        </View>
      </ScrollView>
    </View>
